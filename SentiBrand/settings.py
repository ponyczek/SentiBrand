...
SECRET_KEY = 'b(t=^a(h$wikwsknachj9)w2_jbsey(s_@ad5&q&q#!wazl6_h'
...
WSGI_APPLICATION = 'SentiBrand.wsgi.application'
...
# CELERY_IMPORTS = ('taskscheduler.task',)
